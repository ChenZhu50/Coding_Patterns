...
public class Main {
    public static void main(String[] args) {
        ...
        // newWeights[weights.length] = new int[]{63, 55, 47, 83, 61, 82, 6, 34, 9, 38,
        // 6, 69, 17,
        ...
        // newValues[values.length] = new int[]{35, 47, 8, 103, 83, 71, 11, 107, 9, 34,
        // 41, 54, 73,
     ...
     * 2. 如果weights[index] > capacity，返回helper(capacity, weights, values, dp, index
     * - 1)
     * 3. 返回Math.max(helper(capacity, weights, values, dp, index - 1), values[index]
     * + helper(capacity - weights[index], weights, values, dp, index - 1))
     ...
     * public static int findMaxKnapsackProfit(int capacity, int[] weights, int[]
     * values) {
     ...
     * }
     * 
     * public static int findMaxKnapsackProfitHelper(int capacity, int[] weights,
     * int[] values, int n, int[][] dp) {
     * //base case
     * if (n == 0 || capacity == 0) {
     * return 0;
     * }
     ...
     * //放
     * values[n-1] +
     * findMaxKnapsackProfitHelper(capacity - weights[n-1], weights, values, n-1,
     * dp)
     * 
     * );
     ...
     * dp[n][capacity] = findMaxKnapsackProfitHelper(capacity, weights, values, n-1,
     * dp);
     * return dp[n][capacity];
     * }
     */
    ...
    // solution three: bottom up with space optimization
